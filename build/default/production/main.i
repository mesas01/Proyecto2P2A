...
# 862 "./mcc_generated_files/adcc.h"
void ADCC_ISR(void);
...
void leerSegundaSenal(){
    ...
    signal_No_DC_2 = signal_DC_2 - 0b0000011111111111;
}

void leerPrimeraSenal(){
    signal_DC_1 = ADCC_GetSingleConversion(channel_ANA0);
    signal_No_DC_1 = signal_DC_1 - 0b0000011111111111;
}

void sendToUART(){

    uint8_t mostrarBajo = (signal_No_DC_1 & 0xFF);
    uint8_t mostrarAlto = (signal_No_DC_1 >> 8);
...
void main(void) {
    ...
    while(1){
        ...
        DAC_SPI = (uint16_t)(0b0011000000000000) | ((resulOperacion + 0b0000011111111111) );
        DAC_SPI_High = (DAC_SPI>>8);
        DAC_SPI_Low = (DAC_SPI );
        LATEbits.LATE0 = 0;
        LATBbits.LATB4 = 0;
        ...
        DAC_SPI = (uint16_t)(0b1011000000000000) | (signal_No_DC_1 );
        DAC_SPI_High = (DAC_SPI>>8);
        LATEbits.LATE0 = 0;
        LATBbits.LATB4 = 0;
        SPI1_ExchangeByte(DAC_SPI_High);
